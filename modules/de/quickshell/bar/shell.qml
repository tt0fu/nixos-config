...
ShellRoot {
    PanelWindow {
        ...
        property real topEdge: bar.implicitHeight
        property real leftEdge: 10
        property real rightEdge: 10
        property real bottomEdge: 10
        ...
        Rectangle {
            id: leftRect
            color: "transparent"
            x: leftMouse.containsMouse ? 0 : viewRect.x - width
