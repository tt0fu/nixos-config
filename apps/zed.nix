            ...
            themes = [
              {
                ...
                style =
                  ...
                  in
                  {
                    ...
                    "tab.active_background" = white1;
                    "search.match_background" = white2;
                    ...
                    "scrollbar.thumb.background" = white1;
                    "scrollbar.thumb.hover_background" = white2;
                    ...
                    "editor.highlighted_line.background" = white2;
                    "editor.line_number" = white2;
                    "editor.active_line_number" = white;
                    "editor.invisible" = white2;
                    "editor.wrap_guide" = inactive;
                    "editor.active_wrap_guide" = active;
                    "editor.document_highlight.bracket_background" = white1;
                    "editor.document_highlight.read_background" = white2;
                    "editor.document_highlight.write_background" = white2;
